          ...
          fields: {
            user: {
              ...
              rules: [
                {
                  type   : 'empty',
                  prompt : 'Por favor ingresa un usuario'
                }
              ]
            },
            password: {
              ...
              rules: [
                {
                  type   : 'empty',
                  prompt : 'Por favor ingresa una contraseña'
                }
              ]
            }
          }
      ...
      <div class="ui stacked segment">
        <div class="field">
          <div class="ui left icon input">
            <i class="user icon"></i>
            <input type="text" name="username" autofocus placeholder="Usuario">
          </div>
        </div>
        <div class="field">
          <div class="ui left icon input">
        ...
        <div class="ui fluid large blue submit button">Ingresar</div>
      </div>
